...
public class MyWalkingRouteOverlay extends WalkingRouteOverlay
{
	...
	public MyWalkingRouteOverlay(BaiduMap mBaiduMap)
	{
		super(mBaiduMap);
	...
	{
		WalkingStep step = (WalkingStep) route.getAllStep().get(arg0);
		String str = step.getInstructions();

		LatLng latLng = ((WalkingStep) route.getAllStep().get(arg0))
